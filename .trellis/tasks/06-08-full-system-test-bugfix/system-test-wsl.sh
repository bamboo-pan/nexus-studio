...
TASK_DIR="${TASK_DIR:-$SRC/.trellis/tasks/06-08-full-system-test-bugfix}"
...
grep -Ev '^.. \.trellis/tasks/06-08-full-system-test-bugfix(/|$)' "$RUN_ROOT/source-status.txt" > "$RUN_ROOT/source-status-product.txt" || true
grep -E '^.. \.trellis/tasks/06-08-full-system-test-bugfix(/|$)' "$RUN_ROOT/source-status.txt" > "$RUN_ROOT/source-status-task-harness.txt" || true
...
grep -Ev '^.. \.trellis/tasks/06-08-full-system-test-bugfix(/|$)' "$RUN_ROOT/test-copy-status.txt" > "$RUN_ROOT/test-copy-status-product.txt" || true
grep -E '^.. \.trellis/tasks/06-08-full-system-test-bugfix(/|$)' "$RUN_ROOT/test-copy-status.txt" > "$RUN_ROOT/test-copy-status-task-harness.txt" || true
